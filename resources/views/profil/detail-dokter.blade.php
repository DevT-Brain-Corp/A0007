...
<body class="profile-page sidebar-collapse">
  ...
  <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="400">
    <div class="container">
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navigation" data-nav-image="{{asset('5.jpg')}}">
        <ul class="navbar-nav">
          <li class="nav-item">
  ...
  <div class="wrapper">
    <div class="page-header clear-filter page-header-small">
      ...
      <div class="container">
        <div class="photo-container">
          <img src="{{asset('foto-dokter.png')}}" alt="">
        </div>
        <h3 class="title">{{$dokter->user->name}}</h3>
        <p class="category">{{$dokter->user->role}}</p>
    ...
    <div class="section">
      <div class="container">
        ...
        <h5 class="description">Ini merupakan artikel yang ditulis oleh <strong>{{$dokter->user->name}}</strong></h5>

<div class="row">
@foreach($dokter->user->artikel as $d)
